...
print(
  ...
  f"()  -> {expand()}\n"
    ...
    hypothesis.
    \begin{pyblock}[default1][highlightlines={10,21-22}]
class Person:
...
print(person_default)
    ...
    \mintinline{python}{person_A}, \mintinline{python}{person_B} and 
    \mintinline{python}{person_default} all refer to the same object.
...
test_function()
    ...
    test code is executed, supporting our hypothesis that the default value is 
