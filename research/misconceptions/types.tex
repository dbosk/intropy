...
use a string in a function call. When including a string as a parameter, 
for example \verb'foo("Hello World")', students instead write \verb'foo(
Hello World)', where the misconception is about the syntax of declaring a 
string. 
