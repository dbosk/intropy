...
går att dela upp; här är det du som skriver programmen.  Vi börjar i ett
program du bara ska läsa och förutsäga, går vidare till två
...
sista steg.  Och till sist får du läsa ett program som någon annan har
skrivit och säga vad som gör det svårt att läsa, ändra och använda.
Varje uppgift följs av ett lösningsförslag, och det är ett förslag:
nästan varje uppgift går att lösa på flera rimliga sätt.
