...
\begin{restatable}{lo}{OvningVariablesLOOutput}\label{OvningVariablesLOOutput}%
  Skriva ut ett beräknat värde med \mintinline{python}{print} och
  f-strängar så att den som kör programmet kan använda svaret.
\end{restatable}
% Lo11
...
\mintinline{python}{return}, och att en funktion kan anropa en annan.
