...
\cref{sec:fem-fel} är kursens tydligaste exempel på att det ena håller
och det andra inte.
...
\begin{description}
  ...
  \item[Docstringens nytta] Att en docstring gör att den som ska använda
    funktionen slipper läsa dess kropp (\cref{sec:fem-fel}).
  ...
  \item[Verb för funktioner] Att en funktion bör heta något som säger
    ...
    (\cref{sec:fem-fel}).  PEP~8 föreskriver inte ordklassen, och
  ...
  \item[Att granska andras kod] Att läsa och granska någon annans
    program gör den egna koden tydligare (\cref{sec:fem-fel}).  Det är
...
enligt arbetsgången ovan.  Tills det är gjort står de som de står här:
