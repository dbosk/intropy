...
I \cref{sec:kommentarer} står att ni ska följa stilreglerna i
PEP~8\autocite{pep8} \enquote{av samma skäl som vi valde beskrivande
namn: koden ska gå att läsa för någon annan än den som skrev den}.  Det
är inget påstående om vad PEP~8 \emph{säger} --- det står i PEP~8 och är
lätt att slå upp --- utan ett påstående om vad stilregler \emph{gör} med
en läsare.  \Cref{sec:fraga} använder just den frågan som exempel på ett
påstående som går att pröva, och det här kapitlet prövar den: \emph{blir
koden lättare att läsa för någon annan av att den följer en stilguide som
PEP~8, och kostar det något att låta bli?}
...
\cref{sec:pep8-slutsats} ger det; \cref{tab:sok-pep8} sist i kapitlet
listar de träffar som rör påståendet.

\section{Metod}
\label{sec:pep8-metod}

Frågan söktes ämnesdrivet och tvåsidigt den 6 september 2026 mot de
databaser som svarade: OpenAlex, DBLP, IEEE Xplore, arXiv, Web of Science
och Scopus.  Semantic Scholar avvisade sin nyckel och saknas därför helt.
IEEE Xplores dygnskvot tog slut efter de tjugosex långa frågorna, så
nollorna i IEEE-kolumnen för de åtta korta frågorna betyder \enquote{inte
prövad}, inte \enquote{ingen träff}.  DBLP söker bara i titlar och tar
bort citattecken och operatorer, vilket gör varje flerbegreppsfråga till
ett krav på att alla orden står i samma titel; därför är DBLP-kolumnen
noll för de långa frågorna, och därför ställdes samma frågor en gång till
i kort form.
...
databas.  Högst 25 träffar hämtades per databas och fråga, så en 25 i
tabellen betyder \enquote{minst 25}.
...
%                     Two edits to the generated fragment, to match the
%                     other decks: the provider column heading reads
%                     "Databas" rather than the exporter's "Leverantor",
%                     and "open access" in the caption is wrapped in
...
\begin{longtable}{@{}ll%
  ...
  \caption{Sökfrågor och antal träffar per databas, stilguiders nytta,
    6~september 2026, verktyget \texttt{scholar}.  S = stödfråga,
    C = motfråga, T = kort omfråga ställd för DBLP:s skull; bokstaven i
    andra kolumnen är delfrågan, (a)~namn, (b)~utseende, (c)~konvention,
    (d)~PEP~8 och nybörjare, (e)~motsökning.  Databaser: OpenAlex (OA;
    inte \foreignlanguage{english}{open access}), DBLP, IEEE Xplore
    (IEEE), arXiv, Web of Science (WoS), Scopus.  Högst 25 träffar
    hämtades per databas och fråga, så 25 betyder \enquote{minst 25}.
    \textsuperscript{a}~IEEE Xplores dygnskvot tog slut före de korta
    frågorna; nollorna där betyder \enquote{inte prövad}.  Frågan visas i
    den booleska form som skickades till OpenAlex, IEEE Xplore och arXiv;
    Web of Science fick samma sträng som \texttt{TS=(\dots)} och Scopus
    som \texttt{TITLE-ABS-KEY(\dots)}.  Semantic Scholar avvisade sin
    nyckel och prövades inte.}%
  ...
  T1 & (a) & identifier names comprehension
     & 25 & 2 & 0\textsuperscript{a} & 25 & 25 & 25 \\
  T2 & (a) & identifier style eye tracking
     & 25 & 1 & 0\textsuperscript{a} & 25 & 3 & 4 \\
  T3 & (b) & indentation comprehension
     & 25 & 4 & 0\textsuperscript{a} & 25 & 25 & 25 \\
  T4 & (b) & code readability metric
     & 25 & 5 & 0\textsuperscript{a} & 25 & 25 & 25 \\
  T5 & (c) & coding conventions readability
     & 25 & 0 & 0\textsuperscript{a} & 25 & 25 & 25 \\
  T6 & (d) & programming style automated feedback students
     & 25 & 0 & 0\textsuperscript{a} & 25 & 25 & 24 \\
  \midrule
  ...
  T7 & (e) & coding style experiment negative results
     & 25 & 0 & 0\textsuperscript{a} & 25 & 19 & 11 \\
  T8 & (e) & program comprehension replication experiment
     & 24 & 2 & 0\textsuperscript{a} & 25 & 23 & 21 \\
\end{longtable}
\endgroup
...
kategorierna lästes.  Arton källor citeras nedan; tolv av dem lästes i
fulltext och sex fanns bara tillgängliga som sammanfattning, vilket står
vid var och en.
...
developers}}.  Dos Santos och Gerosa lät läsare jämföra kodstycken två
...
samma studie fann ingen skillnad i träffsäkerhet, och en senare studie
fann det omvända för vissa
uppgifter\autocite[avsnitt~4]{Oliveira2023FormattingSLR}.
De två studierna av frågan är alltså oense.
...
ställningstagande, inte ett experiment, och citeras som ett sådant.
...
till flera av artiklarna ovan, men det står inte prövat någonstans.
...
Det är precis den avgränsning den här modulen gör: ni ska veta att guiden
finns och följa den, inte lära er den utantill.  Och att ens namnregeln
är självklar i undervisningen stämmer inte --- tio intervjuade lärare i
...
alls\autocite[sammanfattningen]{vanderWerf2024TeachersNaming}.
...
den här kursen: Schankins effekt av beskrivande namn syntes hos vana
utvecklare men inte hos ovana, och nästan alla studier har
...
Delvis, och svagare än man skulle tro.  Det som har stöd är att koden
...
blanksteg i indrag har prövats och gav ingen skillnad --- läsarna
föredrog rentav den kod som bröt mot regeln --- och mellanslag runt
...
\Cref{tab:sok-pep8} listar de poster som rör påståendet --- citerade,
...
\cref{tab:sok-queries-pep8}.
\input{litteratursokning/pep8-stil-full}
