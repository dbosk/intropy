...
\caption{Träffar som rör påståendet, PEP 8 och kodstil (18 citerade, 83 som stöder påståendet och 70 som kvalificerar eller motsäger det, av 1824 unika träffar; de 631 angränsande och 1022 felträffarna listas inte). Skälet till varje inkludering står i sista kolumnen; för maskinklassade rader anges modellens konfidens. Databaser: OpenAlex (OA; inte \foreignlanguage{english}{open access}), DBLP, IEEE Xplore (IEEE), Web of Science (WoS), Scopus, arXiv.}\label{tab:sok-pep8}\\
\toprule
