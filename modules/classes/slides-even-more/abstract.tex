...
\emph{Förkunskaper}
Studenten bör ha tagit del av föreläsningarna \emph{Klasser och objekt},
\emph{Operatoröverlagring}, \emph{Behållare: Listor} och \emph{Behållare:
Uppslagslistor}: studenten ska kunna skriva en klass med attribut,
metoder, \mintinline{python}{__init__} och \mintinline{python}{__str__},
ärva från en klass och anropa \mintinline{python}{super()}, använda
egenskaper samt lagra data i listor, listbyggare
(\foreignlanguage{english}{list comprehensions}) och uppslagslistor.
