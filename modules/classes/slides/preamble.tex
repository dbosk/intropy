...
% PythonTeX runs two of the tangled example programs and embeds their
% real output --- the transcripts in \cref{ex:two-run,ex:private-run}
% are produced by the programs themselves, so they cannot drift from the
% code.  pythontex runs from ltxobj (the outputdir); workingdir=.. moves
