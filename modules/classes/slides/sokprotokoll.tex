...
I \cref{sec:klasser-objekt,sec:dundermetoder} ställer materialet tre
frågor som inte fanns i tidigare versioner: var de två objekten finns
...
missuppfattningar i programmering redan har prövat: de tre källorna ovan
kommer från den genomgångens litteraturprotokoll, där de hittades i en
...
Sammanlagt gav sökningarna 411 unika poster.  Alla klassades: först med
...
sammanfattning.  De källor som citeras nedan lästes i fulltext där den
gick att nå; för de övriga står det i källfilen att bara sammanfattningen
lästs, och \cref{sec:miss-diskussion} återkommer till det.  Hur varje
källa hittades och verifierades är antecknat på det sätt
\cref{app:verifiera} beskriver.

Fyra titlar i \cref{tab:sok-missuppfattningar} rättades för hand vid
genomläsningen, och rättelserna redovisas därför att en rättelse man
inte kan kontrollera inte är någon rättelse.  Tre av dem bar spår av
\textsc{html}-tecken i leverantörernas titlar: citattecknen kring
\enquote{this} och apostroferna i \enquote{Students'} hade kommit ut som
obearbetade styrsekvenser.  Den fjärde var avhuggen mitt i titeln av
exportens teckengräns och står nu fullständig.  Ingen rad bytte
kategori.
...
of these misconceptions}.  Sökningen gav därutöver ett dussin poster
som stöder påståendet utan att ha lästs i fulltext; de står som
stödjande i \cref{tab:sok-missuppfattningar}.
...
Sammanlagt gav sökningarna 448 unika poster.  Alla klassades på samma
...
konfidens under 0,7.  Ordet \emph{encapsulation} betyder annat i andra
fält --- solceller, läkemedel, nätverkspaket --- och drygt hundra poster
föll bort av det skälet.  De källor som citeras nedan lästes i fulltext
där den gick att nå; för de övriga står det i källfilen att bara
...
Svaret vilar på tre källor lästa i fulltext (Parnas, Snyder, Sullivan
