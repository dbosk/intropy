...
% PythonTeX runs the tangled test program and embeds its real output ---
% the transcript shown at the end of the deck is produced by the program
% itself, so it cannot drift from the code.  pythontex runs from ltxobj
% (the outputdir); workingdir=.. moves it up to the deck directory so
% examples/... resolves.
