...
uppgifter, om arv och om komposition.  Varje uppgift följs av ett
...
ställer upp, med ett tillägg: målet om dundermetoder omfattar här också
\mintinline{python}{__eq__}, som föreläsningen beskriver men inte
implementerar och som modulens mål räknar upp.  Efter övningen ska
studenten kunna:
...
styrstrukturer}, \emph{Upprepningar}, \emph{Behållare: Listor} och
\emph{Behållare: Uppslagslistor}: studenten ska kunna skriva en funktion
med parametrar och returvärde, använda villkor och upprepningar och
lagra data i listor och uppslagslistor.  Särfall
