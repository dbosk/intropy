...
vad som händer med två objekt när bara det ena får ett anrop.  Längs
vägen kopplar vi in Pythons inbyggda operationer på våra egna objekt, en
dundermetod i taget: utskrift, ordning, likhet och sist de fyra
