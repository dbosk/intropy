...
% answered in an earlier deck's appendix (a lecture, or Övning:
% Funktioner och variabler), and the three that are not are listed in
% Fortsatt arbete.  No \chapterprecis here -- that sentence
...
bilagorna till tidigare material, och tabellen anger vilken; de tre sista är
...
\begin{table}[!ht]
  ...
  \begin{tabular}{@{}lp{0.38\linewidth}p{0.32\linewidth}@{}}
    ...
    1 & Leder det till bättre lärande att försöka lösa ett problem
        innan begreppet lärs ut? & Ja, med förbehåll; \emph{Övning:
        Funktioner och variabler}, bilaga~B \\
...
Sex av de nio frågorna har redan ett svar, sökt en gång i det
material där påståendet först gjordes.  Då söks de inte om här.  I
