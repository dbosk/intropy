...
sidan visar övningen med en körning, och du kan göra om den själv.  Men
...
\begin{enumerate}
  ...
  \item att inkapsling skyddar ett objekts data (lärandemålen);
...
svaret på varje påstående finns.  Fem av de sju är redan prövade i
föreläsningarnas bilagor, och tabellen anger vilken; de två sista är
...
\begin{table}[htbp]
  \centering
  \caption{Övningens sju påståenden som frågor, och var svaren finns.
    Numren i första kolumnen är påståendenas nummer i listan ovan.
  ...
  \begin{tabular}{@{}lp{0.38\linewidth}p{0.32\linewidth}@{}}
    ...
    3 & Är inkapsling en etablerad princip i objektorienterad
        ...
        bilaga~C \\
    4 & Hjälper det läsaren att koden följer PEP~8? & Delvis, och
    ...
    5 & Är det bra att inte upprepa sig, och kommer DRY från Hunt och
        ...
        bilaga~E \\
    6 & Minskar en klass risken för fel när flera delar av ett program
        ändrar samma data? & Oprövat; se \cref{sec:ovn-fortsatt} \\
    7 & Utvecklar det designförmågan att granska andras kod? &
...
Lägg märke till vilka påståenden som hamnar i listan ovan.  Det är inte
...
Fem av de sju frågorna har redan ett svar, sökt en gång i den
...
föreläsningarnas, och varje sådan kopia har fått en extra rad som säger
att den är en kopia, vilken bilaga som bär prövningen och att källan
inte lästs om här.  Utan den raden hade det sett ut som om övningen
själv hade läst allt, och det hade varit osant.

\section{Fortsatt arbete}
\label{sec:ovn-fortsatt}

Två av övningens påståenden är oprövade, och båda är av samma slag: de
låter som självklarheter och är det inte.
...
Båda frågorna ska ställas ämnesdrivet, i samma databaser och med samma
