...
% PythonTeX runs every tangled solution program and embeds its real
% output, so a solution's code and the output it is said to produce
% cannot drift apart.  pythontex runs from ltxobj (the outputdir);
% workingdir=.. moves it up to the deck directory so examples/...
% resolves.
