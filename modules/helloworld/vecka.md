...
En översikt över hela Pythondelen och dess lärandemål finns på sidan
*Python-delen: översikt och lärandemål* i modulen *Översikt Python-delen*.
Varje vecka har en egen sida som den här överst i sin modul.
