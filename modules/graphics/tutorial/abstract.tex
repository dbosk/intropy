...
som skriver, väntar och skriver igen, och sedan i ett fönster --- där den
slingan inte längre går att använda.  Skillnaden mellan de två
...
\end{restatable}
% Lo05 (interaktion med användaren), Lo08 (händelsestyrda program)
...
\begin{restatable}{lo}{OvningGraphicsLOBind}%
  ...
  gränssnittet.
\end{restatable}
% Lo03 (dela upp program), Lo09 (sammansatta datatyper)
...
\end{restatable}
Övningen lägger till en aspekt som föreläsningen inte namnger, men som
varje uppgift efter den första kräver:
% Lo08 (händelsestyrda program), Lo09 (sammansatta datatyper)
...
här.\footnote{\label{fn:pydoc-tkinter}%
  \url{https://docs.python.org/3/library/tkinter.html} (hämtad
  2026-09-17).}
Samma text finns i terminalen, ett bibliotek eller en klass i taget:
\texttt{pydoc3 tkinter.Tk}, \texttt{pydoc3 tkinter.Canvas} och så
vidare.
