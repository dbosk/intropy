...
körningen \emph{avbryts}, och Python skriver en \emph{traceback}.  Vi
...
\begin{restatable}{lo}{ExcLOException}\label{ExcLOException}%
  ...
  och redogöra för vad som händer när ett särfall inte tas om hand:
  körningen avbryts där felet uppstod och de följande raderna körs
  aldrig.
\end{restatable}
% Lo08 (interaktiva program), Lo11 (granska program)
\begin{restatable}{lo}{ExcLOTraceback}\label{ExcLOTraceback}%
  Läsa en traceback och ur den utläsa var felet uppstod, vilken sorts
...
\begin{restatable}{lo}{ExcLOCatch}\label{ExcLOCatch}%
  ...
  allmänna --- och redogöra för att resten av
  \mintinline{python}{try}-blocket då hoppas över.
\end{restatable}
...
egna funktioner med parametrar och returvärden från förra veckan, samt
inmatning med \mintinline{python}{input} och typomvandling och
\mintinline{python}{while} från veckans föreläsning om inmatning och
styrstrukturer.
