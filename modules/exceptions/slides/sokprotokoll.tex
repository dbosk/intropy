...
\label{app:nyborjare}
\chapterprecis{Författaren har granskat de citerade källorna i fulltext,
  men inte hela träfflistan rad för rad.}
...
säger hur vanlig missuppfattningen är i vecka 39 på en första kurs.  Vad
...
projekt med kodgranskning och statisk analys är inte samma miljö som en
laboration, och \enquote{ovanliga buggar} i Eclipse säger inte att en
nybörjares allmänna gren är ofarlig.  Tvärtom illustrerar
