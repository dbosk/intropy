...
ur dem en algoritms \emph{huvudbeståndsdelar}: att stegen utförs i
...
\begin{restatable}{lo}{CompThinkLOComponents}\label{CompThinkLOComponents}%
  ...
  exekveringsordning (steg utförs ett i taget, i ordning), variabler och
  tillstånd, förgreningar, upprepningar och funktioner.
\end{restatable}
