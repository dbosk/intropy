...
\mintinline{python}{in} är precis det \cref{sec:generalisering} visar som
felkod.  Felet att aldrig sätta räknaren tas upp i \cref{sec:while}, men
...
studien är \citeauthor{Kapur2014}s \parencite{Kapur2014}: två randomiserade
försök där eleverna
...
Ingen studie i materialet skiljer de två åt.  Därtill vet ingen var
gränsen för hur mycket som måste hållas i huvudet samtidigt går för
programmeringsexempel på två till sju rader.  Föll ett sådant försök ut
till ordningens fördel skulle materialets uppläggning vila på ett belägg
