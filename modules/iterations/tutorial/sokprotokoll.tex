...
gör är antingen redan kontrollerat i en av föreläsningarna
\emph{Algoritmiskt tänkande}, \emph{Funktioner} och \emph{Upprepningar}
eller i \emph{Övning: Funktioner och variabler}, och pekas då ut där,
eller ännu inte kontrollerat, och räknas då upp i
...
\begin{table}[htbp]
  ...
  \caption{Övningens påståenden om forskning och om lärande, och var
    ...
    här bilagan: övningen har inte gjort någon egen sökning.  Raderna
    står i den ordning påståendena möter läsaren.}
  ...
  \begin{tabular}{@{}p{0.50\linewidth}p{0.44\linewidth}@{}}
    ...
    Att det lönar sig att försöka själv innan man läser
      ...
      av väntan
      & Redan belagt i \emph{Övning: Funktioner och variabler},
        bilaga~B \\
    Att kontrast måste upplevas samtidigt för att en aspekt ska bli
      urskiljbar
      & Läst i fulltext, s.~45--47 hos Marton \\
    Att en öppen fråga visar vilka aspekter studenten redan urskiljer
    ...
    Råd och en missuppfattning som övningen ger utan belägg
      & Inte kontrollerade; se \cref{sec:fortsatt} \\
    \bottomrule
  \end{tabular}
\end{table}

Andra och tredje raden förtjänar en kommentar.  Båda påståendena om
lärande i marginalens lärarnoter vilar på Martons \emph{Necessary
Conditions of Learning}, men inte lika stadigt.  Citaten på sidorna
45--47 är kontrollerade mot boken; citatet på sidan 89 är hämtat ur en
andrahandsuppteckning som anger boken och sidan, och är alltså inte läst
i original här.  Det står i litteraturlistans källfil,
...
och det är ett påstående som kan prövas.  Råden i
...
Några påståenden i övningen är inte kontrollerade, och de är av två slag.

De flesta är \emph{råd}: att en namngiven konstant är lättare att ändra
...
(\cref{sec:multtabell}).  Alla påstår en nytta, och föreläsningarna
\emph{Upprepningar} och \emph{Behållare: Listor} gör flera av dem utan
belägg.  Frågan att söka på är i
varje fall densamma: finns det någon studie som har mätt den nyttan, och
vad säger de som har försökt och inte funnit den?

Det andra slaget är en \emph{missuppfattning} som namnges utan källa:
att 5 är det vanliga felsvaret på frågan om det största indexet i en
lista med fem element (\cref{sec:listan}).  Föreläsningen
\emph{Behållare: Listor} citerar två källor om listindex, men har ingen
granskad bilaga att peka på, så påståendet kan inte återanvändas
härifrån.

Därtill återstår mer att göra.  Aritmetikens fundamentalsats anges i
