\emph{Översikt}
Den här övningen låter dig använda filhanteringen på riktiga uppgifter:
...
Uppgifterna bygger på varandra: den första samlar de frågor om filer som
alla de andra programmen behöver --- finns filen?  får den skrivas
över? --- i en egen modul, och sedan används den modulen om och om igen.
De sista uppgifterna är fördjupning och kan hoppas över.
