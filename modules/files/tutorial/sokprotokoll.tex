...
sig mot är gjorda i tidigare bilagor.

\begin{table}[!htb]
  \centering
  \caption{Övningens påståenden som frågor, och var svaret står.
    \enquote{Bilaga} avser bilagan i den föreläsning eller övning som
    namnges;
  ...
  \begin{tabular}{@{}p{0.48\linewidth}p{0.42\linewidth}@{}}
    ...
    Lär man sig mer av att lösa problemet före genomgången, och vad i
      ordningen är det som verkar? & \emph{Övning: Funktioner och
      variabler}, bilaga B \\
...
\begin{description}
  ...
  \item[Översikter] (\foreignlanguage{english}{reviews}) för om något är
    ...
    fråga, och svaret i \emph{Övning: Funktioner och variabler},
    bilaga B, vilar på en
...
den här övningen söktes upp här: alla är återanvända ur tidigare
bilagor, och varje post säger vilken bilaga som besvarar frågan.
