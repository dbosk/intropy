...
tiden och vilka som stått still, och inget av påståendena prövades
genom att köra kod: alla lästes.  Standardkodningen är den punkt där
dokumentationen själv är i rörelse --- rekommendationen att alltid ange
kodning är ett tecken på det --- och vilken förändring som är på gång
har inte följts upp här.

Det som skulle göra svaret hållbart över tid är ingen studie utan en
kontroll som går att köra om: en uppsättning små program som prövar
vart och ett av påståendena --- att filen stängs vid fel, att
\mintinline{python}{write} inte lägger till något, att en saknad fil
ger \mintinline{python}{FileNotFoundError} --- mot varje Python-utgåva
kursen stöder, och som säger till när något slutar gälla.  En öppen
