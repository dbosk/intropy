...
\Cref{app:missuppfattningar} tillämpar en del av den på de fem
påståendena i listan: källorna är lästa om, men någon ny sökning har
inte gjorts (\cref{sec:cond-metod}).  \Cref{tab:paastaaenden-cond}
...
genomgående som funktioner, och skälet som anges är att ett material
som inte följer sin egen rekommendation får den att framstå som
frivillig.  Det är ett empiriskt påstående om hur studenter uppfattar
ett kursmaterial, och ingen sökning har gjorts för det; den tvåsidiga
frågan --- lär sig studenter en praxis bättre när exemplen genomgående
följer den, och finns det studier som visar motsatsen? --- är ett eget
kapitel som återstår att skriva.
