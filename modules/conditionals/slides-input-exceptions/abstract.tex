...
den som körde det efter namn och födelseår, men vi sa bara en mening om
hur det gick till.  Den här modulen tar upp de raderna igen.  Vi
...
för användaren i stället för för programmeraren.  Sist ser vi hur våra
egna funktioner kan \emph{kasta} särfall vidare till den som anropat
dem.
