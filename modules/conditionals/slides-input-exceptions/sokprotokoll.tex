...
%   source            : the printed Lgr22 (Upplaga 2, 2024, ISBN
%                       978-91-38-32792-0), pp. 55--57, read in full
%                       text; the same kursplan was read first on
%                       Skolverket's own site (URL and access date in the
%                       provenance block).
%   provenance        : ltnotes.bib, key Skolverket2022Lgr22 (CLAIM /
%                       FOUND-VIA / PICKED / QUOTE / VERIFIED / COUNTER /
%                       DATE).  The print/web wording difference is
%                       recorded there and in sec:lgr22-metod.
...
decimalform i grundskolans kursplan i matematik?}

\section{Metod}
\label{sec:lgr22-metod}

Det här kapitlet redovisar ingen sökning, och gör inget försök att se
ut som om det gjorde det.  Frågan gäller vad ett enda namngivet
dokument säger, och dokumentet är både offentligt och primärt:
läroplanen för grundskolan, förskoleklassen och fritidshemmet, med
dess kursplan i matematik\autocite[55--57]{Skolverket2022Lgr22}.
Arbetsgången i \cref{app:verifiera} börjar med att välja rätt sorts
källa, och för en fråga om vad skolan ska undervisa om är rätt sorts
källa styrdokumentet självt; ingen sekundärlitteratur kan säga det mer
direkt, och en databassökning skulle bara leda tillbaka till samma
text.

Texten lästes först på Skolverkets egen webbplats, där kursplanen i
matematik är märkt som gällande från den 1 juli 2022, och därefter i
den tryckta utgåvan --- andra upplagan, från 2024 --- som är den som
citeras här, eftersom den har sidnummer.  De två versionerna stämmer
ordagrant i de punkter kapitlet vilar på, med ett undantag som inte rör
frågan: i tryck följs punkten om metoder för beräkningar av meningen
...
förekommer inte i kursplanen.  Att en division av två naturliga tal kan
redovisas som en kvot och en rest är aritmetik och följer av att talen
är naturliga; det är inte ett citat ur styrdokumentet.  Materialet
formulerar sig därefter: det säger att \enquote{7 delat med 2 är 3,
rest 1} hör hemma bland de fyra räknesätten med hela tal, inte att
kursplanen skriver så.

\section{Diskussion och begränsningar}
\label{sec:lgr22-diskussion}

Källan är stark för den fråga som ställdes och svag för en fråga som
ligger nära.  Kursplanen är ett styrdokument: den säger vad
...
Därtill följde den som lämnade grundskolan före 2022 en annan läroplan,
och den som gick i skolan i ett annat land en tredje; för studenter som
läst utomlands är påståendet en generalisering.

En andra inskränkning gäller ordningen.  Kursplanen ger inte
decimaltalen först i årskurs 4--6 i betydelsen att eleverna aldrig sett
dem tidigare --- den anger när de blir centralt innehåll.  Redan i
årskurs 1--3 står \enquote{tal i bråkform som del av helhet och del av
antal}\autocite[55]{Skolverket2022Lgr22}, så det är inte alla tal utom
de hela som saknas i lågstadiet; det är \emph{decimalformen}.  Den
skillnaden avgör hur påståendet får formuleras, och materialet säger
därför decimaltal och inte \enquote{tal som inte är hela}.

\section{Slutsats}
\label{sec:lgr22-slutsats}

De fyra räknesätten med naturliga tal är centralt innehåll redan i
årskurs 1--3, medan tal i decimalform och beräkningar med dem kommer
först i årskurs 4--6.  Den ordning materialet stödjer sig på är alltså
den kursplanen föreskriver, och påståendet i \cref{sec:datatyper} står
kvar som det är skrivet --- med förbehållet att kursplanen anger
innehåll och inte utfall, och att kvoten och resten är aritmetik och
inte ett citat.
...
samband} eller bara en möjlig.  Den andra är en jämförelse med de
läroplaner studenterna faktiskt gick under --- den föregående svenska
för dem som lämnade grundskolan före 2022, och de utländska för dem som
läst i ett annat land.  Först då vet materialet om \enquote{du har mött
dem båda} gäller för gruppen och inte bara för skolans nuvarande
uppdrag.
