...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{0.50\linewidth}p{0.42\linewidth}@{}}
    ...
    Blir man bättre på att skriva program av att granska andras, och
...
%   reused entries    : ltnotes.bib, keys Marton2015 SooriBosk2026
...
%                       Kapur2014 SinhaKapur2021 -- each entry carries
