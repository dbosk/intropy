...
ett färdigt program som ska granskas och med en funktion som ska
byggas ut, och slutar i program som skrivs från början och som ska
tåla vad som helst.  De två sista uppgifterna är fördjupning.  Varje
uppgift följs av ett lösningsförslag med förklaring, och där uppgiften
består i att skriva ett program är förslaget ett färdigt program, så
att den som inte hann igenom allt kan arbeta vidare på egen hand.
