\emph{Översikt}
Övningen består av nio uppgifter om interaktiva program: program som
frågar den som kör dem, tål svar som inte går att använda, väljer väg
och gör om något så länge det behövs.  Vi börjar i det enklaste --- att
\emph{läsa} ett villkor och räkna ut vad det blir värt --- fortsätter
med ett färdigt program som ska granskas och med en funktion som ska
byggas ut, och slutar med program som skrivs från början och som ska
tåla vad som helst, och med att bygga vidare på två av dem.  De fyra
sista uppgifterna är fördjupning.  Varje uppgift följs av ett
lösningsförslag med förklaring, och där uppgiften består i att skriva
ett program är förslaget ett färdigt program, så att den som inte hann
igenom allt kan arbeta vidare på egen hand.
...
\begin{restatable}{lo}{OvningConditionalsLOBranch}%
  ...
  för att högst en gren exekveras (exakt en med
  \mintinline{python}{else}) och att programmet fortsätter efteråt.
\end{restatable}
% Lo11
...
\begin{restatable}{lo}{OvningConditionalsLOCatch}%
  ...
  Fånga de särfall programmet vet hur det ska svara på med
  \mintinline{python}{try} och \mintinline{python}{except}, och
  redogöra för vad som händer i programmet.
\end{restatable}
% Lo03, Lo04
