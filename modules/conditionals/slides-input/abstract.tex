\emph{Översikt}
Hittills har programmen mest räknat på värden som stod skrivna i koden:
ett namn, ett årtal, en längd.  Ett sådant program gör exakt samma sak
varje gång det körs.  Den här modulen gör programmen
\emph{interaktiva}: de frågar den som kör dem --- det som
åldersprogrammet i föreläsningen \emph{Variabler och utskrifter} gjorde
utan att vi förklarade hur.  Vi använder \mintinline{python}{input} för att
...
\emph{Förkunskaper}
Modulen bygger på föreläsningen \emph{Funktioner}:
