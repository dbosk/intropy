...
\author{Daniel Bosk\thanks{%
    Licenserad under Creative Commons Attribution-Share Alike (CC BY-SA 4.0), 
...
\begin{frame}
  ...
  \begin{block}<+>{Kunskaper}
    \begin{itemize}
      ...
      \item Procedurell programmering
      \item Datastrukturer
      \item Programmerings\emph{teknik}
    \end{itemize}
  \end{block}
...
\begin{frame}
  \begin{block}{Moduler}
    \begin{enumerate}
      \item Förberedelse (Övrigt i TimeEdit)
      \item Övning (Föreläsning i TimeEdit)
      \item Datorlaboration
      \item Fördjupande övning (Övning i TimeEdit)
    \end{enumerate}
  \end{block}
...
\mode<all>{\input{disciplinary.tex}}
