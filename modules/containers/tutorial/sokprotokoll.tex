...
\begin{enumerate}
  ...
  \item att samma startvärde till slumpgeneratorn ger samma följd varje
    gång (\cref{sec:humor});
  \item att Python speglar en jämförelse när den vänstra operandens
    klass saknar metoden, och att en klass som skriver en egen
    \mintinline{python}{__eq__} förlorar den \mintinline{python}{__hash__}
    den ärvt (\cref{sec:brak});
...
\begin{table}[!htb]
  \centering
  \caption{Övningens påståenden, som frågor, och var svaret finns.
    Raderna 1--5 är frågor om vad Python gör och besvaras av Pythons egen
    dokumentation, läst i fulltext för veckans föreläsningar; rad~6 är
    inte belagd och står i \cref{sec:ovning-fortsatt}; rad~7 är belagd i
    föreläsningen \emph{Funktioner}; rad~8 gäller
    marginalanteckningarna.}
  ...
  \begin{tabular}{@{}p{0.46\linewidth}p{0.44\linewidth}@{}}
    ...
    inte?
      & Primärkälla: dokumentationen för modulen
        ...
        samma föreläsning.  Ja --- en \mintinline{python}{deque} är
        billig i båda ändar, en lista bara i den bakre. \\
    Måste en nyckel vara oföränderlig?
      & Primärkälla: Pythons handledning, kapitlet \emph{Data
        ...
        \emph{Behållare: Uppslagslistor}.  Ja --- nyckeln måste vara av
        en oföränderlig typ. \\
    Ger samma startvärde samma följd av slumptal?
      & Primärkälla: dokumentationen för modulen
        \mintinline{python}{random}, läst i fulltext 2026-09-03 för
        föreläsningen \emph{Behållare: Ett gissningsspel}.  Ja ---
        generatorn är helt deterministisk. \\
    Speglar Python en jämförelse, och förlorar en klass med egen
    \mintinline{python}{__eq__} sin \mintinline{python}{__hash__}?
      & Primärkälla: Pythons språkreferens, avsnittet \emph{Basic
        customization}, läst i fulltext 2026-09-03 för föreläsningen
        \emph{Klasser och objekt}.  Ja på det första; på det andra säger
        källan att båda metoderna finns från början, och körningen i
        \cref{sec:brak} visar vad som händer när den ena skrivs om. \\
    ...
    urskiljning den ber om?
      & Primärkälla: Marton, \emph{Necessary Conditions of Learning},
        s.~45--47 respektive s.~13 och 91.  Ja på båda. \\
    \bottomrule
  \end{tabular}
\end{table}
...
Den som söker på namn hen redan känner till hittar det hen väntar sig.
...
redovisad i en av föreläsningarna.  Tre påståenden i övningen
...
\end{enumerate}
Gemensamt för två av de tre är att körningen i materialet visar
...
Två påståenden som stod här i en tidigare version är strukna, och skälet
är värt att notera: de var redan belagda någon annanstans.  Både
dekoratorn \mintinline{python}{functools.total_ordering} och regeln om
\mintinline{python}{__eq__} och \mintinline{python}{__hash__} är
kontrollerade i fulltext för föreläsningen \emph{Klasser och objekt}, och
de citaten är kopierade hit med sin proveniens i stället för att sökas
på nytt.  Att först leta efter ett belägg i sitt eget material är
billigare än att söka, och det är den första frågan att ställa.
