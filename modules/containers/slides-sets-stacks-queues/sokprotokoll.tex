...
\begin{enumerate}
  ...
  \item att lösningen ska hållas enkel --- principen
    \foreignlanguage{english}{KISS} (\cref{sec:valja});
...
behöver (\foreignlanguage{english}{KISS}) namnges här; det vetenskapliga
underlaget för \foreignlanguage{english}{KISS} --- både var principen
kommer ifrån och om den håller --- finns i föreläsningen
\emph{Funktioner}, bilaga~C.
