...
flera påståenden i ett: \enquote{en etablerad princip som härrör från Hunt
och Thomas} är två frågor, om \emph{ursprung} och om \emph{etablering},
...
De är antingen frågor om vad Python gör --- och besvaras då av Pythons
egen dokumentation\autocite{PythonDataStructures}, som är
primärkällan --- eller påståenden som redan är belagda i ett tidigare
avsnitt av kursen.  Att DRY är en etablerad princip som härrör från Hunt
och Thomas är belagt i \emph{Algoritmiskt tänkande}, bilaga~E, med svaret
\enquote{ja, med förbehåll}\autocite{HuntThomas1999}; principerna om ett
ansvar per funktion (\foreignlanguage{english}{SRP}) och om att hålla
lösningen enkel (\foreignlanguage{english}{KISS}) beläggs i kursens modul
om funktioner.  Att kontrast måste upplevas samtidigt för att en aspekt
ska kunna urskiljas är hämtat från Martons \emph{Necessary Conditions of
...
lär ut, tillämpad på litteraturen.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{0.46\linewidth}p{0.44\linewidth}@{}}
    ...
    \emph{DRY} från Hunt och Thomas?
      & Redan belagt i \emph{Algoritmiskt tänkande}, bilaga~E: ja, med
        förbehåll. \\
    Har en funktion ett ansvar, och ska lösningen hållas enkel?
      & Belagt i kursens modul om funktioner; namnen återanvänds här. \\
