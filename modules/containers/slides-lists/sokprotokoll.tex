...
principerna om ett ansvar per funktion (\foreignlanguage{english}{SRP})
och om att hålla lösningen enkel (\foreignlanguage{english}{KISS}) finns
i föreläsningen \emph{Funktioner}, bilaga~B respektive~C.
