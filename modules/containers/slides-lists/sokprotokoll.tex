...
primärkällan --- eller påståenden som redan är belagda någon annanstans.
Att DRY är en etablerad princip som härrör från Hunt och Thomas är belagt
i \emph{Algoritmiskt tänkande}, bilaga~E, med svaret \enquote{ja, med
förbehåll}\autocite{HuntThomas1999}; principerna om ett ansvar per
funktion (\foreignlanguage{english}{SRP}) och om att hålla lösningen
enkel (\foreignlanguage{english}{KISS}) beläggs i kursens modul om
funktioner.  Att kontrast måste upplevas samtidigt för att en aspekt ska
...
inte vad den skulle kunna bära.
