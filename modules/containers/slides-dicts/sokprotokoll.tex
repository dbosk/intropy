...
\begin{enumerate}
  ...
  \item att nybörjare har missuppfattningar om hur listor refereras
...
\emph{Funktioner}, bilaga~C: att enkelhet är ett etablerat designvärde,
medan den vanliga upphovsuppgiften inte går att bekräfta.  Underlaget
för \foreignlanguage{english}{SRP} --- att en funktion ska ha ett
ansvar --- finns i samma föreläsnings bilaga~B: att principen härrör
från Martin och är etablerad, medan vad som räknas som \emph{ett} ansvar
förblir en bedömningsfråga.  Att kontrast måste upplevas
