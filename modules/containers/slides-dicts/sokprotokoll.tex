...
missuppfattningarna är.  Två principer namnges här utan att beläggas
här: det vetenskapliga underlaget för
\foreignlanguage{english}{KISS} --- att välja den enklaste behållare som
klarar de operationer man behöver --- finns i föreläsningen
\emph{Funktioner}, bilaga~C, som svarar både på var principen kommer
ifrån och om den håller, och underlaget för
\foreignlanguage{english}{SRP} --- att en funktion ska ha ett ansvar ---
finns i samma föreläsnings bilaga~B, som svarar både på var principen
kommer ifrån och hur säker den är.  Att kontrast måste upplevas
