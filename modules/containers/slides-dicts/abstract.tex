...
plats utan ett \emph{namn} --- telefonnumret som hör till Ronja, priset
...
\mintinline{python}{while}-slingor, egna funktioner, att importera en
egen modul samt felhantering med
\mintinline{python}{try}/\mintinline{python}{except}.
