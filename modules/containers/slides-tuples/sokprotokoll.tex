...
här; det vetenskapliga underlaget finns i föreläsningen
\emph{Funktioner}, bilaga~C.  Att kontrast måste
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{0.46\linewidth}p{0.44\linewidth}@{}}
    ...
    Ska lösningen hållas enkel (\foreignlanguage{english}{KISS})?
      & Redan belagt i föreläsningen \emph{Funktioner}, bilaga~C. \\
