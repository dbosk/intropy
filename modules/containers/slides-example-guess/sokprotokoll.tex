...
\begin{table}[!htb]
  ...
  \begin{tabular}{@{}p{0.46\linewidth}p{0.44\linewidth}@{}}
    ...
    (\foreignlanguage{english}{SRP})?
      & Redan belagt i föreläsningen \emph{Funktioner}, bilaga~B: att
        principen härrör från Martin och är etablerad, medan vad som
        räknas som \emph{ett} ansvar förblir en bedömningsfråga. \\
...
funktion --- finns i föreläsningen \emph{Funktioner}, bilaga~B: att
principen härrör från Martin och är etablerad, medan vad som räknas som
\emph{ett} ansvar förblir en bedömningsfråga.  Underlaget för
\foreignlanguage{english}{KISS} --- att hålla lösningen enkel --- finns
i samma föreläsnings bilaga~C: att enkelhet är ett etablerat
designvärde, medan den vanliga upphovsuppgiften inte går att bekräfta.
Att kontrast måste upplevas
